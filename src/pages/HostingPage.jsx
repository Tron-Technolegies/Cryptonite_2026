      ...
      <div className="container-x mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-gray-600">
            Secure, low-cost, and sustainable Bitcoin mining hosting in strategic locations
            worldwide. Choose the facility that best fits your mining needs.
          </p>
        </div>
          ...
          {miningLocations.map((loc) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-500 mb-6 line-clamp-2 text-sm">{loc.description}</p>
                ...
                <div className="flex items-center justify-between mt-auto">
                  <div>
                    ...
                    <span className="text-lg font-bold text-gray-900">
                      {loc.price} <span className="text-xs font-normal text-gray-400">/ kWh</span>
                    </span>
                  </div>
                  <Link
                    to={`/locations/${loc.id}`}
